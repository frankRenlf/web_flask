...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://:''@150.158.173.160:3306' \
                                        '/dietsystem?charset=utf8 '
...
# 初始化数据库连接
# engine = create_engine('mysql+pymysql://root:123456789''@150.158.173.160:3306/toDoList?charset=utf8')
# engine = create_engine('mysql+pymysql://SmartHome:emA8kP3nxSSpx3eY''@150.158.173.160:3306/smarthome?charset=utf8')
# root 是你用户名  1-9 密码，  150.158.173.160改变改成127。0。0。1
# engine = create_engine('mysql+pymysql://dietSystem:EXAWBRjrZ2tLmYPG''@150.158.173.160:3306/dietsystem?charset=utf8')
